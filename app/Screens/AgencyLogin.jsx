...
const AgencyLogin = () => {
  ...
  const handleLogin = () => {
    ...
    axios.post('https://etix-mobile-app-deployed-1.onrender.com/driverRoutes/driverLogin', {
      driverName: name,
  ...
  return (
    <ScrollView className="w-full px-5">
      <View className="relative flex-row w-full mt-10 items-center justify-center">
        ...
        <Text className="text-3xl font-bold">Agency Login</Text>
      </View>
      ...
      <View className="w-full flex items-center mt-16">
        ...
        <TouchableOpacity onPress={handleLogin} className={`w-full flex items-center py-4 mt-7 bg-blue-600 rounded-full`}>
          <Text className="text-white font-bold">{loading ? <ActivityIndicator size={30} color={'white'} /> : 'Sign In'}</Text>
        </TouchableOpacity>
        <View className="my-3 flex-row justify-center gap-x-3">
          ...
          <TouchableOpacity onPress={() => navigator.navigate('agencySignup')}>
            <Text className="font-bold text-blue-600 underline">Sign Up</Text>
          </TouchableOpacity>
          <View />
        </View>
