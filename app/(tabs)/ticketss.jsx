...
const Tickets = () => {
    ...
    if (ticket) {
      ...
      const fetchTickets = async () => {
        try {
          ...
          const response = await fetch('https://etix-mobile-app-deployed-1.onrender.com/findTickets', {
            method: 'POST',
            headers: {
  ...
  const handleGetYourBoughtTicket = async (ticketDetails) => {
    ...
    try {
      ...
      const response = await fetch('https://etix-mobile-app-deployed-1.onrender.com/getYourBoughtTicket', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        {ticketFromData && ticketFromData.qrCode ? (
          ...
          <View>
            <Text style={styles.noTicketsText}>No tickets foundd.</Text>
            <TouchableOpacity
